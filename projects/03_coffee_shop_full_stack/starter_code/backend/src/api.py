...
# POST /drinks expects a body with 'title' and 'recipe'
# and will returns {"success": True, "drinks": [drink.long()]}
...
# delete drink /drinks/<int:drink_id>
# returns {'success' : True, 'delete': drink_id})
